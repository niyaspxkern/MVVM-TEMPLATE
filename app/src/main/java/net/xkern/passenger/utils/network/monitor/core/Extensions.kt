package net.xkern.passenger.utils.network.monitor.core
...
import net.xkern.passenger.utils.network.monitor.NetworkConnectivityListener
...
internal fun NetworkConnectivityListener.onListenerResume() {
    ...
    val isConnected = net.xkern.passenger.utils.network.monitor.ConnectivityStateHolder.isConnected
    ...
    if (connectionLost || connectionBack) {
        networkConnectivityChanged(net.xkern.passenger.utils.network.monitor.Event.ConnectivityEvent(isConnected))
    }
